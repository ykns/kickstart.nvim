...
vim.keymap.set('n', '[t', '<cmd>-tabnext<CR>', { desc = 'Prev tab' })

-- buffer/tab close
vim.keymap.set('n', '<leader>xd', '<cmd>bd<CR>', { desc = 'Close buffer' })
vim.keymap.set('n', '<leader>xD', '<cmd>bd!<CR>', { desc = 'Force close buffer' })
